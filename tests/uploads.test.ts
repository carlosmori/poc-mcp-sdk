import fs from 'fs';
import type { ResponseLike } from 'mcp_poc_stainless/internal/to-file';
import { toFile } from 'mcp_poc_stainless/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('mcp_poc_stainless/core/uploads');
    await expect(
