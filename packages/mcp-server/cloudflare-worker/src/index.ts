...
import { ClientOptions } from 'mcp_poc_stainless';
import { McpOptions } from 'mcp_poc_stainless_mcp/options';
import { initMcpServer, newMcpServer } from 'mcp_poc_stainless_mcp/server';
import { configureLogger } from 'mcp_poc_stainless_mcp/logger';
...
function fallbackMcpServer(): McpServer {
  return new McpServer(
    { name: 'mcp_poc_stainless_api', version: '0.0.1' },
