# Mcp Poc Stainless TypeScript MCP Server
...
> [!NOTE]
> Once this package is [published to npm](https://www.stainless.com/docs/guides/publish), this will become: `npx -y mcp_poc_stainless_mcp`
...
| ----------------------------- | ------------------------ | --------------- |
| `x-mcp-poc-stainless-api-key` | `apiKey` | bearerAuth |
